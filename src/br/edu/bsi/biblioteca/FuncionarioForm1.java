 ...
 * @author Carlos
 */
public class FuncionarioForm1 extends javax.swing.JFrame {

    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(FuncionarioForm1.class.getName());

    /**
     * Creates new form FuncionarioForm
     */
    public FuncionarioForm1() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new FuncionarioForm1().setVisible(true));
    }
